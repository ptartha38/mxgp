                ...
                <div class="col-12 col-md-9">
                    <select name="akses" id="akses" class="form-control">
                        ...
                        <optgroup label="TERPILIH SEBELUMNYA" <?= ($validation->hasError('nama_lengkap') or $validation->hasError('jk') or $validation->hasError('tempat_lahir') or $validation->hasError('tgl_lahir') or $validation->hasError('alamat') or $validation->hasError('email') or $validation->hasError('password') or $validation->hasError('foto') or $validation->hasError('foto_ktp')) ? '' : 'hidden' ?>>
                            <option <?= ($validation->hasError('nama_lengkap') or $validation->hasError('pangkat') or $validation->hasError('hp') or $validation->hasError('jk') or $validation->hasError('tempat_lahir') or $validation->hasError('tgl_lahir') or $validation->hasError('alamat') or $validation->hasError('email') or $validation->hasError('password') or $validation->hasError('foto') or $validation->hasError('foto_ktp')) ? 'selected' : 'hidden' ?> value="<?= old('akses') ?>"><?= old('akses') ?></option>
                        </optgroup>
                    </select>
                </div>
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <select name="pangkat" id="pangkat" class="form-control">
                        ...
                        <optgroup label="TERPILIH SEBELUMNYA" <?= ($validation->hasError('nama_lengkap') or $validation->hasError('jk') or $validation->hasError('tempat_lahir') or $validation->hasError('tgl_lahir') or $validation->hasError('alamat') or $validation->hasError('email') or $validation->hasError('password') or $validation->hasError('foto') or $validation->hasError('foto_ktp')) ? '' : 'hidden' ?>>
                            <option <?= ($validation->hasError('nama_lengkap') or $validation->hasError('akses') or $validation->hasError('lokasi_pam') or $validation->hasError('jk') or $validation->hasError('hp') or $validation->hasError('tempat_lahir') or $validation->hasError('tgl_lahir') or $validation->hasError('alamat') or $validation->hasError('email') or $validation->hasError('password') or $validation->hasError('foto') or $validation->hasError('foto_ktp')) ? 'selected' : 'hidden' ?> value="<?= old('pangkat') ?>"><?= old('pangkat') ?></option>
                        </optgroup>
                    </select>
                </div>
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <select name="agama" id="agama" class="form-control">
                        ...
                        <optgroup label="TERPILIH SEBELUMNYA" <?= ($validation->hasError('nama_lengkap') or $validation->hasError('jk') or $validation->hasError('tempat_lahir') or $validation->hasError('tgl_lahir') or $validation->hasError('alamat') or $validation->hasError('email') or $validation->hasError('password') or $validation->hasError('foto') or $validation->hasError('foto_ktp')) ? '' : 'hidden' ?>>
                            <option <?= ($validation->hasError('nama_lengkap') or $validation->hasError('akses') or $validation->hasError('lokasi_pam') or $validation->hasError('pangkat') or $validation->hasError('hp') or $validation->hasError('jk') or $validation->hasError('tempat_lahir') or $validation->hasError('tgl_lahir') or $validation->hasError('alamat') or $validation->hasError('email') or $validation->hasError('password') or $validation->hasError('foto') or $validation->hasError('foto_ktp')) ? 'selected' : 'hidden' ?> value="<?= old('agama') ?>"><?= old('agama') ?></option>
                        </optgroup>
                    </select>
                </div>
            </div>
